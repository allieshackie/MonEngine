...
PhysicsDebugDraw::PhysicsDebugDraw(EngineContext& engineContext)
	: mEngineContext(engineContext), m_debugMode(btIDebugDraw::DBG_DrawWireframe | btIDebugDraw::DBG_DrawAabb),
...
void PhysicsDebugDraw::drawLine(const btVector3& from1, const btVector3& to1, const btVector3& color1)
{
	...
	mEngineContext.DrawLine(glm::vec3(from1.x(), from1.y(), from1.z()), glm::vec3(to1.x(), to1.y(), to1.z()),
